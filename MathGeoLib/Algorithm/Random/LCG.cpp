...
u32 LCG::Int() {
	...
	#warning Because of code sizeand performance issues, on Emscripten LCG::Int() is currently routed to LCG::IntFast() (TODO: Check if this is still needed for Wasmand rem64 ? )
		return IntFast();
#else
	assert(modulus != 0);
